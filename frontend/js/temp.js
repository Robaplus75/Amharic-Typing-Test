...
// Set the initial text and cursor position
...
document.addEventListener('keypress', (e) => {
  ...
  // Check if the pressed key matches the current character at cursor position
...
// Helper function to get the initial text and cursor position
function getTextAndCursorPosition(initialText) {
  return { text: initialText, cursorPosition: 0 };
}

// Helper function to insert the cursor
